...
<html lang="en" dir="ltr">
  <head>
    ...
    <a href="admin_examine.php" class="btn btn-danger"style="margin-bottom:10px;text-decoration:none;">ย้อนกลับ</a>
    <form action="admin_edit_event_save.php" method="post" enctype="multipart/form-data">
