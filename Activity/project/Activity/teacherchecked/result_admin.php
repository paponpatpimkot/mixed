...
<html lang="en" dir="ltr">
  <head>
    ...
    <form action="result_admin_save.php" method="post" enctype="multipart/form-data">
      ...
      <tr>
          ...
          <th colspan="2">
           ...
           วันของกิจกรรม<input type="date" name="eventdate" class="form-control" style="width:168px; height:20px;" value="<?php echo $date ?>">
             ...
             <div class="form-row">
           วันที่กรอกข้อมูล : <input type="text" name="checkdate" class="form-control" id="inputDates" class="form-control" id="inputDates" style="width:170px; height:20px;" value="<?php echo date_th(date('d-m-Y'))?>"></th>
           </div>
    </tr>
