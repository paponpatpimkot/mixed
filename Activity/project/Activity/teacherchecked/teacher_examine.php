...
?>
  ...
  <div class="container" style="width:620px;">
     <a href="../teacher/teacher/index.php"
       class="btn btn-danger"style="margin-bottom:10px;text-decoration:none;">ย้อนกลับ</a>
       <form action="teacher_edit_event.php" method="post">
  ...
  <select class="form-control" style="width:250px;" name="event">
    ...
    <br>กรุณาเลือกวันที่จะตรวจสอบ<input type="date" name="eventdate" class="form-control" style="width:250px;">
