...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="../teacher/admin/teacher.php">แก้ไขข้อมูลอาจารย์</a>
      </li>
    </ul>

    <ul class="navbar-nav my-2 my-lg-0">
        <a class="nav-link" href="../teacher/admin/edit_admin.php">
          <?php
           echo "คุณ ";
           echo $_SESSION['name'];
           echo " ( สถานภาพ : ";
...
?>
 ...
 <nav class="navbar navbar-expand-lg navbar-light bg-light">
   ...
   <div class="collapse navbar-collapse" id="navbarSupportedContent">
     ...
     <ul class="navbar-nav my-2 my-lg-0">
       <a class="nav-link" href="../teacher/teacher/edit_teacher.php">
           <?php
            echo "คุณ ";
            echo $_SESSION['name'];
            echo " ( สถานภาพ : ";
