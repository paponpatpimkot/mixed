...
error_reporting(0);
  if(@$_SESSION['position']!="ผู้ดูแลระบบ"){
    echo "<script>alert('คุณไม่ใช่ ผู้ดูแลระบบ กรุณา login ใหม่')</script>";
...
<body>
    ...
    <br> 
    <div  class="box" style="margin-left:600px;margin-top:-200px;">        
      <img src="../../images/book.png" style="width:100px;height:100px;">
      <h4>เช็คกิจกรรม : <br></h4>
          <a href="../../teacherchecked/selectadmin.php"style="margin-left:100px;">ดูรายละเอียด</a>
    </div>
    <br>
    <div class="box" style="margin-left:1000px;margin-top:-185px;">         
      <img src="../../images/book.png" style="width:100px;height:100px;">
      <h4>ตรวจสอบผลกิจกรรม : </h4>
          <a href="../../teacherchecked/admin_examine.php"style="margin-left:100px;">ดูรายละเอียด</a>
    </div>
