    ...
    <div class="container">
      ...
      <html lang="en" dir="ltr">
        ...
        <div class="container" style="width:1000px;">
            <a href="tcstudent.php?class_id=<?php echo $classroom?>&class_name=<?php echo $classname?>"class="btn btn-danger"style="margin-bottom:10px;text-decoration:none;">ย้อนกลับ</a>
