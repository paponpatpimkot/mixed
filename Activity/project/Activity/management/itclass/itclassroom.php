...
<a href="add_class.php" class="btn btn-primary" style="margin-bottom:10px;text-decoration:none;">เพิ่มห้อง</a>
  <div style="display:none;margin-top:10px;" id="myDiv" class="animate-bottom">
    ...
    <tr >
        ...
        <?php
        $sql= "SELECT * FROM classroom WHERE class_name like 'สท%' ORDER BY class_name ASC;  ";
        ...
        while($row=mysqli_fetch_array($result)){
          ...
          <tr >
            ...
            <td><a href = "../itstudent/itstudent.php?class_id=<?php echo $row['class_id']?>&class_name=<?php echo $row['class_name']?>"><center>รายชื่อนักเรียน</a>
              </td>
