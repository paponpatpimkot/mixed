...
$row=mysqli_fetch_array($result);
 ...
 <div id="loader"></div>
<br>
   <a href="itclassroom.php?class_id=<?php echo $row['class_name']?>"class="btn btn-danger"style="margin-left:282px;text-decoration:none;">ย้อนกลับ</a>
 ...
 <form action="edit_class_save.php?class_id=<?php echo $row['class_id']?>" method="post" enctype="multipart/form-data">
   ...
   <div class="form-group">
     <label style="color:#000000;">ชื่ออาจารย์ที่ปรึกษา</label>
